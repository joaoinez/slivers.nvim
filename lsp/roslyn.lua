...
local mason_roslyn = vim.fn.stdpath 'data' .. '/mason/bin/roslyn'
local roslyn_cmd = vim.uv.fs_stat(mason_roslyn) and mason_roslyn or 'Microsoft.CodeAnalysis.LanguageServer'
