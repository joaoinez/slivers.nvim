...
if not vim.g.vscode then
  ...
  -- Reinstall specific version of rzls
  --[[ cmd('RzlsInstall', function(opts)
    local version = opts.args ~= '' and opts.args or nil
    local install_cmd = version and ('MasonInstall rzls@' .. version) or 'MasonInstall rzls'
    vim.cmd(install_cmd)
  end, { desc = 'Install specific version of rzls (e.g., :RzlsInstall 0.10.0)', nargs = '?' }) ]]
