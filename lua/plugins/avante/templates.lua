...
M.grammar_correction = 'Correct the text to standard English, but keep any code blocks inside intact.'
M.keywords = 'Extract the main keywords from the following text'
